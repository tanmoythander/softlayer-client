...
module.exports = function(SoftLayer) {
    ...
    SoftLayer.prototype.accountAuthenticationAttribute = function () {
        return this.path('Account_Authentication_Attribute');
    };
    SoftLayer.prototype.accountAuthenticationAttributeType = function () {
        return this.path('Account_Authentication_Attribute_Type');
    };
    SoftLayer.prototype.accountAuthenticationSaml = function () {
        return this.path('Account_Authentication_Saml');
    };
    SoftLayer.prototype.accountBusinessPartner = function () {
        return this.path('Account_Business_Partner');
    };
    SoftLayer.prototype.accountContact = function () {
        return this.path('Account_Contact');
    };
    SoftLayer.prototype.accountExternalSetup = function () {
        return this.path('Account_External_Setup');
    };
    SoftLayer.prototype.accountHistoricalReport = function () {
        return this.path('Account_Historical_Report');
    };
    SoftLayer.prototype.accountInternalIbm = function () {
        return this.path('Account_Internal_Ibm');
    };
    SoftLayer.prototype.accountLinkBluemix = function () {
        return this.path('Account_Link_Bluemix');
    };
    SoftLayer.prototype.accountLinkOpenStack = function () {
        return this.path('Account_Link_OpenStack');
    };
    SoftLayer.prototype.accountLockdownRequest = function () {
        return this.path('Account_Lockdown_Request');
    };
    ...
    SoftLayer.prototype.accountPersonalDataRemoveRequestReview = function () {
        return this.path('Account_PersonalData_RemoveRequestReview');
    };
    SoftLayer.prototype.accountProofOfConcept = function () {
        return this.path('Account_ProofOfConcept');
    };
    SoftLayer.prototype.accountProofOfConceptApprover = function () {
        return this.path('Account_ProofOfConcept_Approver');
    };
    SoftLayer.prototype.accountProofOfConceptApproverRole = function () {
        return this.path('Account_ProofOfConcept_Approver_Role');
    };
    SoftLayer.prototype.accountProofOfConceptApproverType = function () {
        return this.path('Account_ProofOfConcept_Approver_Type');
    };
    SoftLayer.prototype.accountProofOfConceptFundingType = function () {
        return this.path('Account_ProofOfConcept_Funding_Type');
    };
    ...
    SoftLayer.prototype.billingCurrencyCountry = function () {
        return this.path('Billing_Currency_Country');
    };
    ...
    SoftLayer.prototype.billingInvoiceNext = function () {
        return this.path('Billing_Invoice_Next');
    };
    ...
    SoftLayer.prototype.billingItemVirtualDedicatedHost = function () {
        return this.path('Billing_Item_Virtual_DedicatedHost');
    };
    ...
    SoftLayer.prototype.brandBusinessPartner = function () {
        return this.path('Brand_Business_Partner');
    };
    SoftLayer.prototype.brandRestrictionLocationCustomerCountry = function () {
        return this.path('Brand_Restriction_Location_CustomerCountry');
    };
    SoftLayer.prototype.businessPartnerChannel = function () {
        return this.path('Business_Partner_Channel');
    };
    SoftLayer.prototype.businessPartnerSegment = function () {
        return this.path('Business_Partner_Segment');
    };
    SoftLayer.prototype.catalystCompanyType = function () {
        return this.path('Catalyst_Company_Type');
    };
    SoftLayer.prototype.catalystEnrollment = function () {
        return this.path('Catalyst_Enrollment');
    };
    SoftLayer.prototype.complianceReportType = function () {
        return this.path('Compliance_Report_Type');
    };
    ...
    SoftLayer.prototype.dnsDomainRegistrationRegistrantVerificationStatus = function () {
        return this.path('Dns_Domain_Registration_Registrant_Verification_Status');
    };
    ...
    SoftLayer.prototype.emailSubscription = function () {
        return this.path('Email_Subscription');
    };
    SoftLayer.prototype.emailSubscriptionGroup = function () {
        return this.path('Email_Subscription_Group');
    };
    SoftLayer.prototype.eventLog = function () {
        return this.path('Event_Log');
    };
    SoftLayer.prototype.exceptionBrandCreation = function () {
        return this.path('Exception_Brand_Creation');
    };
    SoftLayer.prototype.flexibleCreditProgram = function () {
        return this.path('FlexibleCredit_Program');
    };
    ...
    SoftLayer.prototype.hardwareSecurityModule = function () {
        return this.path('Hardware_SecurityModule');
    };
    SoftLayer.prototype.hardwareSecurityModule750 = function () {
        return this.path('Hardware_SecurityModule750');
    };
    ...
    SoftLayer.prototype.locale = function () {
        return this.path('Locale');
    };
    SoftLayer.prototype.localeCountry = function () {
        return this.path('Locale_Country');
    };
    ...
    SoftLayer.prototype.network = function () {
        return this.path('Network');
    };
    ...
    SoftLayer.prototype.networkCdnMarketplaceAccount = function () {
        return this.path('Network_CdnMarketplace_Account');
    }; 
    SoftLayer.prototype.networkCdnMarketplaceConfigurationBehaviorGeoblocking = function () {
        return this.path('Network_CdnMarketplace_Configuration_Behavior_Geoblocking');
    };
    SoftLayer.prototype.networkCdnMarketplaceConfigurationCachePurge = function () {
        return this.path('Network_CdnMarketplace_Configuration_Cache_Purge');
    };
    SoftLayer.prototype.NetworkCdnMarketplaceConfigurationCacheTimeToLive = function () {
        return this.path('Network_CdnMarketplace_Configuration_Cache_TimeToLive');
    };
    SoftLayer.prototype.networkCdnMarketplaceConfigurationMapping = function () {
        return this.path('Network_CdnMarketplace_Configuration_Mapping');
    };
    SoftLayer.prototype.networkCdnMarketplaceConfigurationMappingPath = function () {
        return this.path('Network_CdnMarketplace_Configuration_Mapping_Path');
    };
    SoftLayer.prototype.networkCdnMarketplaceMetrics = function () {
        return this.path('Network_CdnMarketplace_Metrics');
    };
    SoftLayer.prototype.networkCdnMarketplaceVendor = function () {
        return this.path('Network_CdnMarketplace_Vendor');
    };
    ...
    SoftLayer.prototype.networkDirectLinkLocation = function () {
        return this.path('Network_DirectLink_Location');
    };
    SoftLayer.prototype.networkDirectLinkProvider = function () {
        return this.path('Network_DirectLink_Provider');
    };
    SoftLayer.prototype.networkDirectLinkServiceType = function () {
        return this.path('Network_DirectLink_ServiceType');
    };
    ...
    SoftLayer.prototype.networkGatewayMemberAttribute = function () {
        return this.path('Network_Gateway_Member_Attribute');
    };
    ...
    SoftLayer.prototype.networkInterconnectTenant = function () {
        return this.path('Network_Interconnect_Tenant');
    };
    SoftLayer.prototype.networkLBaaSHealthMonitor = function () {
        return this.path('Network_LBaaS_HealthMonitor');
    };
    SoftLayer.prototype.networkLBaaSL7Member = function () {
        return this.path('Network_LBaaS_L7Member');
    };
    SoftLayer.prototype.networkLBaaSL7Policy = function () {
        return this.path('Network_LBaaS_L7Policy');
    };
    SoftLayer.prototype.networkLBaaSL7Pool = function () {
        return this.path('Network_LBaaS_L7Pool');
    };
    SoftLayer.prototype.networkLBaaSL7Rule = function () {
        return this.path('Network_LBaaS_L7Rule');
    };
    SoftLayer.prototype.networkLBaaSListener = function () {
        return this.path('Network_LBaaS_Listener');
    };
    SoftLayer.prototype.networkLBaaSLoadBalancer = function () {
        return this.path('Network_LBaaS_LoadBalancer');
    };
    SoftLayer.prototype.networkLBaaSMember = function () {
        return this.path('Network_LBaaS_Member');
    };
    SoftLayer.prototype.networkLBaaSSSLCipher = function () {
        return this.path('Network_LBaaS_SSLCipher');
    };
    ...
    SoftLayer.prototype.networkMonitor = function () {
        return this.path('Network_Monitor');
    };
    ...
    SoftLayer.prototype.networkPod = function () {
        return this.path('Network_Pod');
    };
    SoftLayer.prototype.networkSecurityGroup = function () {
        return this.path('Network_SecurityGroup');
    };
    ...
    SoftLayer.prototype.networkStorageAllowedHostHardware = function () {
        return this.path('Network_Storage_Allowed_Host_Hardware');
    };
    SoftLayer.prototype.networkStorageAllowedHostIpAddress = function () {
        return this.path('Network_Storage_Allowed_Host_IpAddress');
    };
    SoftLayer.prototype.networkStorageAllowedHostSubnet = function () {
        return this.path('Network_Storage_Allowed_Host_Subnet');
    };
    SoftLayer.prototype.networkStorageAllowedHostVirtualGuest = function () {
        return this.path('Network_Storage_Allowed_Host_VirtualGuest');
    };
    ...
    SoftLayer.prototype.networkStorageMassDataMigrationCrossRegionCountryXref = function () {
        return this.path('Network_Storage_MassDataMigration_CrossRegion_Country_Xref');
    };
    SoftLayer.prototype.networkStorageMassDataMigrationRequest = function () {
        return this.path('Network_Storage_MassDataMigration_Request');
    };
    SoftLayer.prototype.networkStorageMassDataMigrationRequestKeyContact = function () {
        return this.path('Network_Storage_MassDataMigration_Request_KeyContact');
    };
    SoftLayer.prototype.networkStorageMassDataMigrationRequestStatus = function () {
        return this.path('Network_Storage_MassDataMigration_Request_Status');
    };
    ...
    SoftLayer.prototype.productItemPolicyAssignment = function () {
        return this.path('Product_Item_Policy_Assignment');
    };
    ...
    SoftLayer.prototype.resourceConfiguration = function () {
        return this.path('Resource_Configuration');
    };
    ...
    SoftLayer.prototype.softwareAccountLicense = function () {
        return this.path('Software_AccountLicense');
    };
    ...
    SoftLayer.prototype.ticketAttachmentFile = function () {
        return this.path('Ticket_Attachment_File');
    };
    SoftLayer.prototype.ticketPriority = function () {
        return this.path('Ticket_Priority');
    };
    SoftLayer.prototype.ticketSubject = function () {
        return this.path('Ticket_Subject');
    };
    SoftLayer.prototype.ticketSubjectCategory = function () {
        return this.path('Ticket_Subject_Category');
    };
    SoftLayer.prototype.ticketSurvey = function () {
        return this.path('Ticket_Survey');
    };
    ...
    SoftLayer.prototype.userCustomerOpenIdConnect = function () {
        return this.path('User_Customer_OpenIdConnect');
    };
    SoftLayer.prototype.userCustomerProspectServiceProviderEnrollRequest = function () {
        return this.path('User_Customer_Prospect_ServiceProvider_EnrollRequest');
    };
